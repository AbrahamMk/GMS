...
final class StoreEquipmentItemRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'asset_tag' => [
                ...
                'string',
                'max:100',
                Rule::unique('equipment_items', 'asset_tag')->where('branch_id', $branchId),
            ],
            ...
            'barcode' => [
                ...
                'string',
                'max:255',
                Rule::unique('equipment_items', 'barcode')->where('branch_id', $branchId),
            ],
