...
<template>
    <button
        type="button"
        class="flex h-9 w-9 items-center justify-center rounded-full border border-gms-border bg-gms-surface text-gms-text-secondary transition hover:bg-gms-surface-hover hover:text-gms-text"
