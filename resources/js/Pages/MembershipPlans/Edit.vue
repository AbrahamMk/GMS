...
const form = useForm({
    ...
    type: props.plan.type ?? 'time_based',
    duration_days: props.plan.duration_days ?? '',
    visit_limit: props.plan.visit_limit ?? '',
    price: props.plan.price ?? '',
    currency: props.plan.currency ?? 'KES',
    grace_period_days: props.plan.grace_period_days ?? '0',
    allowed_check_in_window_hours: props.plan.allowed_check_in_window_hours ?? '',
    max_daily_visits: props.plan.max_daily_visits ?? '',
    freeze_allowance_days: props.plan.freeze_allowance_days ?? '0',
    auto_renewable: props.plan.auto_renewable ?? false,
    ...
    <AppLayout>
        <div class="grid gap-6 xl:grid-cols-12">
            <div class="xl:col-span-8 xl:col-start-3">
                <Panel eyebrow="Membership Plans" title="Edit plan">
