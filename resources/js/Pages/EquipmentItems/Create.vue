...
function submit() {
    router.post('/portal/equipment-items', form.value, {
        onError: (e) => { errors.value = e; },
        onSuccess: () => { form.value = { asset_tag: '', name: '', equipment_category_id: '', model: '', barcode: '', serial_number: '', purchase_date: '', warranty_expires_at: '', condition: '', location: '', status: 'available' }; },
    });
}
</script>
...
<template>
    <AppLayout>
        <Panel eyebrow="Assets" title="Add equipment item">
